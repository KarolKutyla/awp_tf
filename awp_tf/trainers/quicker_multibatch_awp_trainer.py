...
from awp_tf.api import quicker_multibatch_awp, layer_scales_selector
...
class Trainer(trainer.Trainer):
    ...
    def __init__(
        ...
        self._batch_processor = quicker_multibatch_awp.AWP(self._classifier, self._robust_loss, self._attack, alt_attack, ls, awp_params)
