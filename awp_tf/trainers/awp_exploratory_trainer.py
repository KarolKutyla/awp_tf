...
from awp_tf.api import exploratory_awp, layer_scales_selector
...
class Trainer(trainer.Trainer):
    ...
    def __init__(
        ...
        self._batch_processor = exploratory_awp.AWP(self._classifier, self._robust_loss, self._attack, ls, awp_params)
