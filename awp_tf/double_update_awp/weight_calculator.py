...
class WeightCalculator:
    ...
    def calculate_weight_perturbation_with_alt_distribution(self, x: tf.Tensor, y: tf.Tensor, x_adv: tf.Tensor, x_alt: tf.Tensor, y_alt: tf.Tensor, x_adv_alt: tf.Tensor) -> None:
        gradients = self._calculate_gradient(x, y, x_adv)
