...
from awp_tf.multidistribution_awp.weight_calculator import WeightCalculator, WeightParams
...
class BatchProcessor:
    ...
    def awp_train_step(self, x_batch, y_batch) -> tuple[tf.Tensor, tf.Tensor, tf.Tensor, tf.Tensor]:
        ...
        self._weight_calculator.calculate_weight_perturbation_on_subset(x_batch, y_batch, x_batch_adv)
